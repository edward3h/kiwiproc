...
<2> Define a query. The SQL statement goes inline with the code.
<3> Records could be separate data types, or inline in the DAO.
<4> Use a default method to transform a result.